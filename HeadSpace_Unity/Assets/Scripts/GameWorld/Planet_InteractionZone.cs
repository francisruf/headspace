...
// Script qui envoie un signal au script PLANET, lorsqu'un objet entre dans le trigger de sa ZONE D'INTERACTION
public class Planet_InteractionZone : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        {
            _parentPlanet.OnInteractionZoneTrigger(collider);
        }
    }
}
